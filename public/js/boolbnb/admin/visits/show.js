...
$(document).ready(function () {
  ...
  var myChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        ...
        data: [totalVisits],
        backgroundColor: ['rgba(255, 48, 92, 0.6)' //   'rgba(255, 99, 132, 0.2)',
        //   'rgba(54, 162, 235, 0.2)',
        //   'rgba(255, 206, 86, 0.2)',
        //   'rgba(75, 192, 192, 0.2)',
  ...
  var trimesterVisits = document.getElementById('trimester-visits').innerHTML; // console.log(trimesterVisits);
  ...
  var semesterVisits = document.getElementById('semester-visits').innerHTML; // console.log(semesterVisits);
  ...
  var dec = document.getElementById('december').innerHTML; //   console.log(monthVisits);
  ...
  var myChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        ...
        backgroundColor: ['rgba(255, 48, 92, 0.6)', 'rgba(255, 48, 92, 0.6)', 'rgba(255, 48, 92, 0.6)', 'rgba(255, 48, 92, 0.6)', 'rgba(255, 48, 92, 0.6)', 'rgba(255, 48, 92, 0.6)', 'rgba(255, 48, 92, 0.6)', 'rgba(255, 48, 92, 0.6)', 'rgba(255, 48, 92, 0.6)', 'rgba(255, 48, 92, 0.6)', 'rgba(255, 48, 92, 0.6)', 'rgba(255, 48, 92, 0.6)'],
  ...
  var dayVisits = document.getElementById('daily-visits').innerHTML; // console.log(dayVisits);
  ...
  var weekVisits = document.getElementById('weekly-visits').innerHTML; // console.log(weekVisits);
